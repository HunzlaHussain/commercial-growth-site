...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="bg-brand-cloud border-b border-brand-border">
        <div className="container mx-auto px-4 py-16 md:py-24 lg:py-[120px] max-w-3xl">
          <article className=" rounded-3xl px-6 py-10 md:px-10 md:py-12">
            <header className="text-center mb-10 md:mb-12">
              <h1 className="font-heading text-3xl md:text-4xl font-bold text-brand-navy leading-tight tracking-tight">
                Client Partnership Terms &amp; Conditions
              </h1>
            </header>

            <div className="space-y-6 text-base leading-relaxed text-brand-slate">
              <p>
            ...
            <div className="mt-10 space-y-10 text-base leading-relaxed text-brand-slate">
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Services</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Definitions</h2>
                <p className="mb-4">For purposes of these Terms:</p>
                <ul className="space-y-2 list-disc pl-5 marker:text-brand-slate">
                  <li>
                    <span className="font-semibold text-brand-navy">&quot;ICP Matrix&quot;</span> means the ideal
                  ...
                  <li>
                    <span className="font-semibold text-brand-navy">&quot;Launch Date&quot;</span> means the date
                  ...
                  <li>
                    <span className="font-semibold text-brand-navy">&quot;Qualified Meeting&quot;</span> means a
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">
                ...
                <ul className="space-y-2 list-disc pl-5 mt-3 marker:text-brand-slate">
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Pay-for-Performance Fees and Billing</h2>
                <p>You agree to a performance fee of $250 per Qualified Meeting.</p>
                <p className="mt-4">
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">ICP Qualification Standard</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Client Responsibilities</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Changes to Scope, ICP, or Campaign Criteria</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Suspension or Termination of Services</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">No Guarantee of Sales or Revenue</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Payment Enforcement</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Governing Law</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Entire Agreement</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Website Updates</h2>
                <p>
              ...
              <section>
                <h2 className="font-heading text-xl md:text-2xl font-semibold text-brand-navy mb-4">Acceptance by Payment</h2>
                <p>
              ...
              <p className="pt-8 mt-8 border-t border-brand-border text-sm text-brand-slate">
              ...
              <p className="pt-6">
                <Link
                  href="/"
                  className="text-primary font-semibold hover:underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm"
                >
                  ← Back to home
                </Link>
              </p>
